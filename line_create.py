...
class line_create:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/line_create/icon.png'
        #create action that will be run by the plugin
        self.action = QAction("line_create", self.iface.mainWindow())
        self.action.setIcon(QIcon(icon_path))
        self.action.setWhatsThis("Create Line")
        self.action.setStatusTip("Click On Map And Draw Line")
        
        # add plugin menu to Vector toolbar
        self.iface.addPluginToMenu("line_create",self.action)
    ...
    def unload(self):
        ...
        self.iface.removePluginMenu("line_create",self.action)
